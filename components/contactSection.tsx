...
const CONTACTS = [
  ...
  {
    id: "04",
    name: "Madanmohan Rana",
    position: "Joint Treasurer",
    gmail: "madanmohanrana2003@gmail.com",
    phone: "+91 8670493369",
    image: "/madanmohan.jpeg",
  },
  {
    id: "05",
    name: "Swarnendu Saha",
...
const T = {
  red: {
    glow: "rgba(200,25,5,0.9)",
    border: "rgba(200,25,5,0.45)",
    text: "#ff6a45",
  },
  purple: {
    glow: "rgba(130,40,210,0.8)",
    border: "rgba(130,40,210,0.4)",
    text: "#b070e8",
  },
};
          ...
          {active && (
            <motion.div
              ...
              style={{
                ...
                boxShadow:
                  "0 0 0 1px rgba(130,40,210,0.12), 0 20px 50px rgba(0,0,0,0.85)",
                background: "#050000",
                position: "relative",
              }}
            >
              ...
              <div
                style={{
                  ...
                  zIndex: 2,
                  background:
                    "linear-gradient(180deg, transparent 35%, rgba(3,0,0,0.97) 100%)",
                }}
              />
              <div
                style={{
      ...
      >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            {isMobile ? (
              ...
              <motion.div
                ...
                style={{
                  color: T.red.text,
                  filter: `drop-shadow(0 0 6px ${T.red.glow})`,
                }}
              >
                <ArrowSVG />
              </motion.div>
        ...
        {!isMobile && (
          ...
          >
            ...
            >
              <span style={{ color: T.purple.text, display: "flex" }}>
                <GmailSVG />
              </span>
              <span
                style={{
            ...
            >
              <span style={{ color: T.red.text, display: "flex" }}>
                <PhoneSVG />
              </span>
              <span
                style={{
  ...
  return (
    <div
      style={{
        ...
        width: "100%",
        background:
          "radial-gradient(ellipse at 5% 10%, rgba(160,8,0,0.22) 0%, transparent 40%), radial-gradient(ellipse at 95% 90%, rgba(100,5,0,0.18) 0%, transparent 40%), #050000",
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(180,8,0,0.14) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
            ...
            >
              <div
                style={{
                  ...
                  height: 1,
                  background:
                    "linear-gradient(90deg, transparent, rgba(200,25,5,0.3))",
                }}
              />
              <span
                style={{
        ...
        >
          <div
            style={{
              width: 36,
              height: 2,
              background: `linear-gradient(90deg, ${T.red.glow}, transparent)`,
              boxShadow: `0 0 5px ${T.red.glow}`,
            }}
          />
          <div
            style={{
              ...
              borderRadius: "50%",
              background: "#fff",
              boxShadow: `0 0 5px ${T.purple.glow}, 0 0 10px ${T.red.glow}`,
              margin: "0 4px",
            }}
          />
          <div
            style={{
              width: 36,
              height: 2,
              background: `linear-gradient(90deg, transparent, ${T.purple.glow})`,
              boxShadow: `0 0 5px ${T.purple.glow}`,
            }}
          />
        </motion.div>
